...
import com.southDragon.springmvc.repository.HistoryGradesDao;
import com.southDragon.springmvc.repository.MathGradesDao;
import com.southDragon.springmvc.repository.ScienceGradesDao;
...
public class GradeBookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("firstname", "Long");
        request.setParameter("lastname", "Tran");
        request.setParameter("emailAddress", "long@gmail.com");
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setLastname("f3");
        student.setEmailAddress("123@gmail");
    ...
    public void createStudentHttpRequest() throws Exception{
        student.setFirstname("hi");
        student.setLastname("f3");
        student.setEmailAddress("12eee3@gmail");
        ...
        CollegeStudent verifyCollegeStudent = studentDao.findByEmailAddress("12eee3@gmail");
        assertNotNull(verifyCollegeStudent,"Student should be valid");
    ...
    @Test
    public void createGradeHttpRequestStudentDoesNotExistResponse() throws Exception{
    ...
    @Test
    public void createNonValidGradeHttpRequestEmptyResponse() throws Exception{
    ...
    @Test
    public void deleteNonValidGradeHttpRequestStudentIdDoesNotExistEmptyResponse() throws Exception{
